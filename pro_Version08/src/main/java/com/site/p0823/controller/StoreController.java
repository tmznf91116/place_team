...
//	}
	...
	@ResponseBody
//	public void ProductOrderCheck(@RequestParam int s_id, @RequestParam int count, @RequestParam String user_Tel,
//			@RequestParam int product_Number, @RequestParam String user_Name, @RequestParam String user_Address1,
//			@RequestParam String user_Address2, @RequestParam String user_Address3, @RequestParam String other)	{
	public void ProductOrderCheck(@RequestParam int s_id, @RequestParam int count,
			@RequestParam int product_Number, user_DetailsVo user_DetailsVo, @RequestParam String other){
	...
	@ResponseBody
	public String kakaoPay(@RequestParam int s_id ,@RequestParam int count ,  @RequestParam int product_Number ) {
		ProductVo productVo = storeService.producerOneSearch(product_Number);
		...
		try {
			...
			//서버로 보낼 데이터
			String UserPayData = "cid=TC0ONETIME&partner_order_id=partner_order_id&partner_user_id=partner_user_id&item_name="+productVo.getProduct_Name()+"&quantity=1&total_amount="+product_Price+"&tax_free_amount=0&approval_url=http://localhost:8888/ProductOrderOk&cancel_url=http://localhost:8888&fail_url=http://localhost:8888";
